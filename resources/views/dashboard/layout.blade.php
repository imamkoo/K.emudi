                ...
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('jadwal.index') }}">
                            ...
                            <span class="menu-title">Jadwal Belajar</span>
                        </a>
                        ...
                        <a class="nav-link" href="{{ route('manual.index') }}">
                            <i class="mdi mdi-file-document-box-outline menu-icon"></i>
                            <span class="menu-title">Kendaraan Manual</span>
                        </a>
                        <a class="nav-link" href="{{ route('matic.index') }}">
                            <i class="mdi mdi-file-document-box-outline menu-icon"></i>
                            <span class="menu-title">Kendaraan Matic</span>
                        </a>
                        <a class="nav-link" href="{{ route('paketJasa.index') }}">
                            <i class="mdi mdi-file-document-box-outline menu-icon"></i>
                            <span class="menu-title">Paket Jasa</span>
                        </a>
                        <a class="nav-link" href="{{ route('settingPaketJasa.index') }}">
                            <i class="mdi mdi-file-document-box-outline menu-icon"></i>
                            <span class="menu-title">Setting Paket Jasa</span>
                        </a>
                        <a class="nav-link" href="{{ route('halaman.index') }}">
                            <i class="mdi mdi-file-document-box-outline menu-icon"></i>
                            <span class="menu-title">Halaman</span>
                        </a>
                        <a class="nav-link" href="{{ route('settingHalaman.index') }}">
                            <i class="mdi mdi-file-document-box-outline menu-icon"></i>
