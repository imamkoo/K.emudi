...
@section('content')
    <form action="{{ route('paketJasa.update',$data->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <input type="text"
            class="form-control form-control-sm" name="price" id="price" aria-describedby="helpId" placeholder="Price" value="{{ $data->price }}">
        </div>
