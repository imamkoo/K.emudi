...
class manualController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.manual.index')->with('data', $data);
    }
    ...
    {
        return view('dashboard.manual.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manual.index')->with('success', 'Data Added!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.manual.edit')->with('data', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('manual.index')->with('success', 'Data Updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('manual.index')->with('success', 'Data Deleted!');
    }
}