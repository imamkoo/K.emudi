...
class pengurusController extends Controller
{
    ...
    {
        $data = trainer::where('tipe', $this->_tipe)->orderBy('updated_at', 'desc')->get();
        return view('dashboard.pengurus.index')->with('data', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pengurus.index')->with('success', 'Data Added!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.pengurus.edit')->with('data', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('pengurus.index')->with('success', 'Data Updated!');;
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pengurus.index')->with('success', 'Data Deleted!');
    }
}